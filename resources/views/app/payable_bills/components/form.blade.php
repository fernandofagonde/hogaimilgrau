                ...
                <div class="list-row">
                    <div class="row">
                        ...
                        <div class="col-4 align-right">
                            <a href="'. url('content/app/payable_billets') .'/'. $billet_file[0] .'" class="button button-secondary button-inline button-small" download>'. Html::icon('icon-download') .'</a>
            ...
            echo '<div class="list-files">
                <div class="list-row">
                    <div class="row">
                        ...
                        <div class="col-4 align-right">
                            <a href="'. url('content/app/payable_receipts') .'/'. $receipt_file[0] .'" class="button button-secondary button-small button-inline" download>'. Html::icon('icon-download') .'</a>
